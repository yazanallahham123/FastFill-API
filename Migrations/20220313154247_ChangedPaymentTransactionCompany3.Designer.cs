...
namespace FastFill_API.Migrations
{
    ...
    [Migration("20220313154247_ChangedPaymentTransactionCompany3")]
    partial class ChangedPaymentTransactionCompany3
    {
            ...
            modelBuilder.Entity("FastFill_API.PaymentTransaction", b =>
                {
                    b.HasOne("FastFill_API.CompanyBranch", "CompanyBranch")
                        ...
                        .HasForeignKey("CompanyBranchId")
                        .HasConstraintName("FK_PaymentTransactions_CompanyBranches")
                        .IsRequired();
